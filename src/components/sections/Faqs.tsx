...
const Faqs = () => {
    return (
        <div className='px-[5%] max-[769px]:px-4 py-10'>
            <p className='text-center text-[30px] max-[600px]:text-[24px] font-bold'>Frequently asked questions</p>
            <p className="text-center max-w-2xl mx-auto text-sm text-black mb-8">
