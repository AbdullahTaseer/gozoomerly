...
const HeroSection = () => {
  return (
    <div className='px-[5%] max-[769px]:px-4 pt-4'>
      <div className='bg-green-500 relative min-h-[calc(100vh-60px)] flex justify-center items-center rounded-2xl overflow-clip'>
        <Image src={LayerImg} alt='' fill className='object-cover' />
        <div className='text-center text-white max-w-[1000px] relative px-4'>
